...
from src.models.model import ESANet, ESANet_DAD, ESANet_OS, ESANet_KD_Auxi,ESANet_DUL_Auxi,ESANet_DUL_Uncertainty
from src.models.model_one_modality import ESANetOneModality, ESANetOneModality_DAD
...
def build_model_original(args, n_classes):
    if not args.pretrained_on_imagenet or args.last_ckpt or \
            args.pretrained_scenenet != '':
        pretrained_on_imagenet = False
    else:
...
def build_model_kd_auxi(args, n_classes):
    if not args.pretrained_on_imagenet or args.last_ckpt or \
            args.pretrained_scenenet != '':
        pretrained_on_imagenet = False
    else:
...
def build_model_dul_auxi(args, n_classes):
    if not args.pretrained_on_imagenet or args.last_ckpt or \
            args.pretrained_scenenet != '':
        pretrained_on_imagenet = False
    else:
...
def build_model_dul_uncertrainty(args, n_classes):
    if not args.pretrained_on_imagenet or args.last_ckpt or \
            args.pretrained_scenenet != '':
        pretrained_on_imagenet = False
    else:
