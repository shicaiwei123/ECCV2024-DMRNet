...
def train_main(args):
    ...
    if args.dataset == 'nyuv2':
        ...
        full_size=True
        checkpoint = torch.load(
            "../results/missing/cityscapes-with-depth/checkpoints_24_02_2023-08_54_08-851210/ckpt_epoch_292.pth",
            map_location=lambda storage, loc: storage)
...
if __name__ == '__main__':
    ...
    for i in range(20):
        i=i+280
        print(i,i,i,i,i)
        # args.save_path="/home/ssd/results/nyuv2/rgbd_r50_dul_auxi_kl3_auxi_0.5/nyuv2/checkpoints_22_05_2025-14_49_32-145314/ckpt_epoch_"+str(i)+".pth"
        # args.save_path="../results/nyuv2/depth_r50/nyuv2/checkpoints_28_02_2023-11_21_15-180760/ckpt_epoch_"+str(i)+".pth"
        args.save_path = "/home/ssd/results/nyuv2/rgbd_r50_dul_auxi_kl3_auxi_0.5/nyuv2/checkpoints_22_05_2025-14_49_32-145314/ckpt_epoch_272.pth"
