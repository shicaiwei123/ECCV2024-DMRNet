...
class VGGSound_dataset(object):
    def __init__(self, path_to_dataset = '/home/data2/shicaiwei/data/audio_text_visual/scratch/shared/beegfs/hchen/train_data/VGGSound_final', frame_interval=1, frame_kept_per_second=1):
        self.path_to_video = os.path.join(path_to_dataset, 'video')
        self.frame_kept_per_second = frame_kept_per_second
        self.path_to_save = os.path.join(path_to_dataset, 'train-video-img', 'Image-{:02d}-FPS'.format(self.frame_kept_per_second))
