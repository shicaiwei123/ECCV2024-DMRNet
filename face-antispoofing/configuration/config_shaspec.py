...
parser.add_argument('--lr_decrease', type=str, default='none', help='the methods of learning rate decay  ')
...
parser.add_argument('--auxi_scale', type=float, default=1.0)
...
parser.add_argument('dao_weight', type=float, default=1.0)
parser.add_argument('dco_weight', type=float, default=0.02)


args = parser.parse_args()
args.backbone = args.backbone + '_' + str(args.version) + "_dao_" + str(args.dao_weight) + "_dco_" + str(
    args.dco_weight)
