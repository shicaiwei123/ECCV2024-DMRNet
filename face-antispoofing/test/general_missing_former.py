...
sys.path.append('..')
from models.surf_mmfomer import SURF_Fomer,SURF_Fomer_Auxi_Weak
...
if __name__ == '__main__':
    ...
    for i in range(3):
        ...
        pretrain_dir = "../output/models/cefa_former_" + str(i) + "__average.pth"
        args.gpu = 2
        args.modal = 'multi'
        args.miss_modal = 0
        ...
        for j in range(len(modality_combination)):
            ...
            print(args.p)
            model = SURF_Fomer_Auxi_Weak(args)
